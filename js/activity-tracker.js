...
const CognoTracker = {
    ...
    async notifyDoctor(activity, percentage) {
        try {
            ...
            const backendUrl = typeof CognoConfig !== 'undefined' ? CognoConfig.getBackendUrl() : (typeof RENDER_BACKEND_URL !== 'undefined' ? RENDER_BACKEND_URL : 'https://new-cogno-version-1-1-backend.onrender.com');
    ...
    async notifyPatientScore(activity, percentage) {
        try {
            ...
            const backendUrl = typeof CognoConfig !== 'undefined' 
                ...
                : (typeof RENDER_BACKEND_URL !== 'undefined' ? RENDER_BACKEND_URL : 'https://new-cogno-version-1-1-backend.onrender.com');
